...
public class BeerInfoSimiliarBeerTest {
    @Test
    public void infoSimiliarBeerShouldBeValid() {
        ...
        List<Beer> filtered = beers.InfoSimilarBeer(
                new Beer (1, "Beer2", "RU", LocalDate.parse("2010-10-25"), 534, true));
